...
<body background="../icon/bg.jpg">
    <!-- /.card -->
    <center>
        <img src="../icon/logo.png" style="width:300px;height:140px;">
    </center>
    <h1 align="center" style="color:black">Silahkan Melakukan pengisian</h1>
    <fieldset style="width: 50%; margin: auto;">
        <legend style="color:#00719C">FORM PEMINJAMAN</legend>
        <center>
            <p style="color :black">Isi Formulir dengan baik dan Jujur</p>
        </center>
        <form action="../system/pinjam.php" method="post" style="color:#00719C">
            <p>
                Nama Lengkap<br />
